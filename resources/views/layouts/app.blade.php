                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            @if (Auth::user()->type == '0')
                                <li class="nav-item">
                                    <a class="nav-link" id="Categories" href="Categories">Categories</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="Sub_Categories" href="Sub_Categories">Sub_Categories</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="store" href="store">stores</a>
                                </li>
                            @elseif(Auth::user()->type == '1')
                                <li class="nav-item">
                                    <a class="nav-link" id="product" href="product">Product</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="edit_profile_store" href="edit_profile_store">My Store</a>
                                </li>
                            @endif
